public interface AESImplementation {
    ...
    // inverse S-box matrix used for invSubBytes()
    ...
    public static final byte[] GMULBY2 = new byte[]{
    ...
    public static final byte[] GMULBY3 = new byte[]{
    ...
    public static final byte[] GMULBY9 = new byte[]{
    ...
    public static final byte[] GMULBY11 = new byte[]{
    ...
    public static final byte[] GMULBY13 = new byte[]{
    ...
    public static final byte[] GMULBY14 = new byte[]{
